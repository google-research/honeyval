...
from third_party.baxbench.scenario_tests.shopping_cart_service import functional_tests
...
ShoppingCartService = BenchmarkApp(
    name=NAME,
    base_path=BASE_PATH,
    openapi_config_path=CONFIG_BASE_PATH / (camel_to_lower(NAME) + ".yaml"),
    functional_tests=functional_tests,
    callback_type=CallbackType.SQL_INJECTION,
)
