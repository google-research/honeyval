...
from third_party.baxbench.scenario_tests.recommendation_service import functional_tests
...
XSS_TARGET_ENDPOINT = "/recommender?tags=all"

RecommendationService = BenchmarkApp(
    name=NAME,
    base_path=BASE_PATH,
    openapi_config_path=CONFIG_BASE_PATH / (camel_to_lower(NAME) + ".yaml"),
    functional_tests=functional_tests,
    xss_target_endpoint=XSS_TARGET_ENDPOINT,
    callback_type=CallbackType.EXFIL_LOCAL_STORAGE,
)
